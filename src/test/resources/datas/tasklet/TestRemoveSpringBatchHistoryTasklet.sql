...
Insert into BATCH_JOB_EXECUTION_PARAMS (JOB_EXECUTION_ID,PARAMETER_TYPE,PARAMETER_NAME,PARAMETER_VALUE,IDENTIFYING)
values (-1,'STRING','param','value','1');
Insert into BATCH_JOB_EXECUTION_PARAMS (JOB_EXECUTION_ID,PARAMETER_TYPE,PARAMETER_NAME,PARAMETER_VALUE,IDENTIFYING)
values (-2,'STRING','param','value','1');
...
values (-11,1,'step1',-1,TIMESTAMP '2012-05-01',TIMESTAMP '2012-05-01',TIMESTAMP '2012-05-01','COMPLETED',1,6,0,6,0,0,0,0,'COMPLETED',null,TIMESTAMP '2012-05-01');
Insert into BATCH_STEP_EXECUTION (STEP_EXECUTION_ID,VERSION,STEP_NAME,JOB_EXECUTION_ID,CREATE_TIME,START_TIME,END_TIME,STATUS,COMMIT_COUNT,READ_COUNT,FILTER_COUNT,WRITE_COUNT,READ_SKIP_COUNT,WRITE_SKIP_COUNT,PROCESS_SKIP_COUNT,ROLLBACK_COUNT,EXIT_CODE,EXIT_MESSAGE,LAST_UPDATED)
values (-12,1,'step1',-2,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),'COMPLETED',1,6,0,6,0,0,0,0,'COMPLETED',null,CURRENT_TIMESTAMP());
