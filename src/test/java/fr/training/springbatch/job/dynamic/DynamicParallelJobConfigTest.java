...
@ActiveProfiles("test")
@SpringBatchTest
@SpringBootTest(classes = { BatchTestConfiguration.class, DynamicParallelJobConfig.class }, properties = { "spring.batch.job.enabled=false",
        "spring.batch.job.names=dynamicParallelJob" })
class DynamicParallelJobConfigTest {
