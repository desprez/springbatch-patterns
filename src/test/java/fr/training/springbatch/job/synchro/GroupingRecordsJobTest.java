...
@SpringBootTest(classes = { BatchTestConfiguration.class, GroupingRecordsJobConfig.class }, properties = { "spring.batch.job.enabled=false",
        "spring.batch.job.names=groupingrecord-job" })
class GroupingRecordsJobTest {
    ...
    @Test
    void groupingRecordStep_should_produce_expected_file() {
        // Given
        ...
        // When
        final JobExecution execution = testUtils.startStep("groupingrecord-step", jobParameters, fixtureExecution.getExecutionContext());
