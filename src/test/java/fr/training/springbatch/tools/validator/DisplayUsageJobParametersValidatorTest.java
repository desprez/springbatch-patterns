...
class DisplayUsageJobParametersValidatorTest {
    ...
    void testValidateRequiredValuesMissing() {
        ...
        // Then
        assertThat(exceptionThatWasThrown.getMessage()).isEqualTo("The JobParameters do not contain required keys: [name, value]");
    }
    ...
    void testValidateOptionalWithImplicitRequiredKey() throws Exception {
        ...
        // Then
        assertThat(exceptionThatWasThrown.getMessage()).isEqualTo("The JobParameters contains keys that are not explicitly optional or required: [foo]");
    }
