...
/**
 * <p>
 * An {@link ItemReader} be able to use 2 StreamReaders (Files or whatever class implements {@link AbstractItemStreamItemReader}) simultaneously and to
 ...
 *
 * <p>
 * <b>not</b> thread-safe because the underline used {@link SingleItemPeekableItemReader } is not.
 * </p>
 *
 * @param <M>
 *            The master Item Type (the aggregate root)
 * @param <S>
 *            The slave Item Type
 * @param <K>
 *            the type of the master item key
 *
 * @author Desprez
 */
public class CompositeAggregateReader<M, S, K extends Comparable<K>> extends AbstractItemStreamItemReader<M> implements InitializingBean {
     ...
     *            {@link Function<M, K>} used to extract the key of the master item.
     */
     ...
     *            {@link Function<S, K>} used to extract the key of the slave item.
     */
     ...
     * </p>
     *
     * @param masterAggregator
     *            {@link BiConsumer<M, S>} function to add the slave Item to the master Item.
     */
