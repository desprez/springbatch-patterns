...
public class EnumerationValidator<E extends Enum<E>> implements JobParametersValidator {

	private final String parameterKey;

	private final Class<E> enumType;

	public EnumerationValidator(final String parameterKey, final Class<E> enumType) {
