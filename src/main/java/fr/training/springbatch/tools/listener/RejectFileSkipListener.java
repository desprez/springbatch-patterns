 ...
 * Note : this class must be used as a bean to gracefully close FileWriter after
 * dispose.
 *
 * @param <T> the target failed item for processor
 * @param <S> the source failed item for writer
 */
