...
/**
 * Generic {@link ItemWriter} that write conditionaly by delegating to a real
 * ItemWriter if a dryrun flag is set.
 *
 * <pre class="code">
 * 	&#064;Bean
 *	public DryRunItemWriter<Person> writer(final JdbcBatchItemWriter<Person> delegate,
 *			&#064;Value("#{jobParameters['dryrun']?:true}") final boolean dryrun) {
 *
