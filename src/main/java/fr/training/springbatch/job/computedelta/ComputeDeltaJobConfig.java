...
public class ComputeDeltaJobConfig extends AbstractJobConfiguration {
	...
	/**
	 * For this job, jobinstance are defined by the <b>today-stock-file</b>
	 * JobParameter to ensure that the same file not be processed more than once.
	 */
	@Bean
	public Job computeDeltaJob(final Step createTable, final Step loadTodayStock, final Step processAddedItems,
			final Step processRemovedItems) {
	 ...
	 */
	@Bean
	public Step loadTodayStock(final FlatFileItemReader<Stock> fileReader,
	 ...
	 * Reade the stockFile.
	 *
	 * @param stockFile the stock N file
	 */
