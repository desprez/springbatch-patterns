...
public class RemiseBancaire extends Record {
    ...
    public String toString() {
        ...
        builder.append("RemiseBancaire [bicBeneficiaire=").append(bicBeneficiaire).append(", bicEmetteur=").append(bicEmetteur).append(", bicDestinataire=")
                .append(bicDestinataire).append(", canalTrans=").append(canalTrans).append(", circuitRglt103=").append(circuitRglt103)
                .append(", codeApplication=").append(codeApplication).append(", dateMessage=").append(dateMessage).append(", famille=").append(famille)
                .append(", identifiantInterne=").append(identifiantInterne).append(", nbreOpeAttentes=").append(nbreOpeAttentes).append(", nbreOperejetees=")
                .append(nbreOperejetees).append(", nbreOpetraitees=").append(nbreOpetraitees).append(", nbreOpetotalRC=").append(nbreOpetotalRC)
                .append(", origine=").append(origine).append(", referenceExterne=").append(referenceExterne).append(", sens=").append(sens).append(", statut=")
                .append(statut).append(", dateCreation=").append(dateCreation).append(", dateModification=").append(dateModification)
                .append(", dateInscription=").append(dateInscription).append(", nombrePA=").append(nombrePA).append(", pisteAudits=").append(pisteAudits)
                .append(", remiseHomogenes=").append(remiseHomogenes).append("]");
