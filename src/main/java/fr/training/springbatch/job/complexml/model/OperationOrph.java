...
public class OperationOrph extends Record {
	...
	public String toString() {
		...
		builder.append("OperationOrph [bicBeneficiaire=").append(bicBeneficiaire).append(", bicEmetteur=")
		.append(bicEmetteur).append(", bicDestinataire=").append(bicDestinataire).append(", canalTrans=")
		.append(canalTrans).append(", cricuitRegl=").append(cricuitRegl).append(", compteDeb=")
		.append(compteDeb).append(", dateMessage=").append(dateMessage).append(", devise=").append(devise)
		.append(", famille=").append(famille).append(", identifiantInterne=").append(identifiantInterne)
		.append(", idInterneRH=").append(idInterneRH).append(", idInterneRC=").append(idInterneRC)
