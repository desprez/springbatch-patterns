...
public class PisteAudit {
	...
	public String toString() {
		...
		builder.append("PisteAudit [codeEvt=").append(codeEvt).append(", dateInscr=").append(dateInscr)
		.append(", idInterne=").append(idInterne).append(", libEvt=").append(libEvt).append(", codeTypeEnt=")
		.append(codeTypeEnt).append(", codeApp=").append(codeApp).append(", dateCrea=").append(dateCrea)
		.append("]");
